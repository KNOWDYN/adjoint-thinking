...
10. Answer the setup interview. The environment is ready when it can route your work to the correct Adjoint Thinking operation and produce the native artefact in the unified response order.
...
10. Answer the setup interview. The environment is ready when Claude can route your work to one active operation, produce the native artefact, and preserve the human verdict.
...
10. Answer the setup interview. The environment is ready when Gemini can route your work to one active operation, produce the native artefact, and apply the unified response order.
...
- Google Help: Use Gems in Gemini Apps — https://support.google.com/gemini/answer/15146780
- Google Help: Tips for creating custom Gems — https://support.google.com/gemini/answer/15235603
